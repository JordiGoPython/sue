...
wget --no-check-certificate https://spark-public.s3.amazonaws.com/startup/code/market-research.js
wget --no-check-certificate https://spark-public.s3.amazonaws.com/startup/code/market-research-wrapper.js
